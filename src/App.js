    ...
    <div className="ui-wrap">
      <div className="ui-body-wrap">
        ...
        <form action="" className="ui-reply-form">
          <textarea name="reply" onChange={데이터변경}></textarea>
          <button className="ui-blue-button" onClick={댓글등록하기}>
            댓글쓰기
          </button>
        </form>
      </div>
...
function Main() {
  ...
  return (
    <div className="ui-wrap">
      ...
      <button className="ui-green-btn" onClick={글등록페이지이동}>
        글 등록
      </button>
